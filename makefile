...
EXEC = projet1
OBJETS = ncurses.o fonctions_interface.o fonctions_fichier.o
NOM_PROJET = PROJET1
...
fonctions_interface.o: fonctions_interface.c fonctions_interface.h
fonctions_fichier.o: fonctions_fichier.c fonctions_fichier.h
projet1.o: projet1.c ncurses.h
